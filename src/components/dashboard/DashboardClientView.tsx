...
import { DashboardStats, ActivityEvent, FamilyEvent } from '@/types';
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8 animate-fade-in">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        ...
        <StatCard
          title={t('dash_stat_generations')}
          value={stats.generations}
          subtitle={`${stats.patriarchsCount} ${t('dash_stat_patriarchs_sub')}${stats.patriarchsCount > 1 ? 's' : ''}`}
          icon={GitFork}
          colorTheme="walnut"
        />

        <StatCard
          title={t('dash_stat_archives')}
          value={events.length}
          subtitle={t('dash_stat_archives_sub')}
          icon={Archive}
          colorTheme="gold"
        />
        ...
        <div className="lg:col-span-5 space-y-8">
          ...
          <div className="bg-gradient-to-br from-[#fbf2eb] to-[#f5ece5] p-6 rounded-2xl border border-[#eae1da] vintage-shadow">
            <h3 className="font-serif font-bold text-lg text-[#1f1b17] mb-2 flex items-center gap-2">
              ...
              {t('dash_patriarchs_origins_title')}
            </h3>
            <p className="text-sm text-[#424844] leading-relaxed mb-4">
              {t('dash_patriarchs_origins_desc')}
            </p>
